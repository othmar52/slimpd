...
class Schema extends AbstractSchema
{
  protected function buildQueries()
  {
    return array(
      ...
      . "  `title` text,\r"
      . "  `relativePath` text,\r"
      . "  `relativePathHash` varchar(11) NOT NULL DEFAULT '',\r"
      ...
      . "  `relativePath` text NOT NULL,\r"
      . "  `relativePathHash` varchar(11) NOT NULL,\r"
      ...
      . "  `relativePath` text NOT NULL,\r"
      . "  `relativePathHash` varchar(11) NOT NULL,\r"
      . "  `relativeDirectoryPath` text NOT NULL,\r"
      . "  `relativeDirectoryPathHash` varchar(11) NOT NULL,\r"
      ...
      . "  `audioCompressionRatio` varchar(24) NOT NULL DEFAULT '0',\r"
      ...
      . "  `audioCompressionRatio` double unsigned NOT NULL DEFAULT '0',\r"
      . "  `audioDataformat` varchar(64) NOT NULL DEFAULT '',\r"
      . "  `audioEncoder` varchar(64) NOT NULL DEFAULT '',\r"
      . "  `audioProfile` varchar(64) NOT NULL DEFAULT '',\r"
      . "  `videoDataformat` varchar(64) NOT NULL DEFAULT '',\r"
