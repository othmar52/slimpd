...
class Filescanner extends \Slimpd\Modules\Importer\AbstractImporter {
    ...
    /**
     * @param array $tagData : tags generated by getId3 library
     * @param array $trackRecord : database record from table:track
     * @return void
     */
    protected function extractEmbeddedBitmaps($tagData, $trackRecord) {
        ...
        foreach($tagData['comments']['picture'] as $bitmapIndex => $bitmapData) {    
            ...
            $phpThumb->setParameter('config_cache_prefix', $trackRecord['relPathHash'].'_' . $bitmapIndex . '_');
    ...
    /**
     * @param \phpThumb &$phpThumb : instance of bitmap library which already has bitmapdata as property
     * @param array $trackRecord : database record from table:track
     * @param array $bitmapData : additional attributes for $phpThumb's bitmap generated by getId3 library
     * @return void
     */
    protected function persistEmbeddedBitmap(&$phpThumb, $trackRecord, $bitmapData) {
        ...
        $bitmap->setRelPath($relPath)
            ...
            ->setTrackUid($trackRecord['uid'])
            ->setRelDirPathHash($trackRecord['relDirPathHash'])
            ->setEmbedded(1)
